    ...
    <div className="mt-[70px]">
      <div className="w-5/6 mx-auto">
        ...
        <p className="text-[20px] text-[#708ab0] dark:text-[#94a9c9] text-center">
          We&apos;re a passionate team devoted to web development. Our designs
          blend pixel-perfect precision with top-notch coding, ensuring speed,
          security, and SEO-friendliness. Your satisfaction is our commitment as
          we pursue perfection in every web design project.
        </p>
        <div className="text-center text-[#708ab0] dark:text-[#94a9c9] flex flex-wrap items-center justify-center mt-[30px] gap-x-4">
          ...
          <div className="flex items-center">
            <Image src="/icons/send.svg" alt="Contact" width={40} height={40} />
