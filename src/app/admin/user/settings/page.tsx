    ...
    <div className="grid grid-cols-1 px-4 pt-6 xl:grid-cols-3 xl:gap-4 dark:bg-gray-900">
      ...
      <div className="col-span-full xl:col-auto">
          ...
          <div className="items-center sm:flex xl:block 2xl:flex sm:space-x-4 xl:space-x-0 2xl:space-x-4">
            ...
            <div>
              ...
              <div className="flex items-center space-x-4">
                <ButtonLiner className="!px-3 !text-sm !py-2 flex items-center justify-center">
                  <svg
        ...
        <div className="p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700 sm:p-6 dark:bg-gray-800">
          ...
          <div>
            <ButtonLiner className="!px-3 !text-sm !py-2">Save all</ButtonLiner>
          </div>
        </div>
        <div className="p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700 sm:p-6 dark:bg-gray-800">
          <div className="flow-root">
            ...
            <div>
              <ButtonLiner className="!px-3 !text-sm !py-2">
                Save all
              </ButtonLiner>
            </div>
          </div>
          ...
          <form action="#">
            <div className="grid grid-cols-6 gap-6">
              ...
              <div className="col-span-6 sm:col-full">
                <ButtonLiner className="!px-3 !text-sm !py-2" type="submit">
                  Save all
                </ButtonLiner>
              </div>
            </div>
