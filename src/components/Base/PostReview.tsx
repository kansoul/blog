    ...
    <a href="#">
      <div className="block sm:flex bg-transparent sm:mb-[60px] mb-20 cursor-default sm:h-[257.05px]">
        <Image
          ...
          alt={post?.title}
        />
        <div className="flex flex-col leading-normal sm:ml-5 mt-4 sm:mt-0 h-full relative">
          ...
          <p className="mb-5 text-sm font-normal text-[#708AB0] dark:text-[#94A9C9] line-clamp-3 overflow-clip">
            {getFirstParagraphContent(post?.content)}
          </p>
